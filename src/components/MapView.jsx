...
function RegionsLayer({ data, onPickRegion }) {
  ...
  return <GeoJSON data={data} style={style} onEachFeature={onEach} />;
}

//  Composant départements 
function DeptsLayer({ data, selectedDeptCode, setSelectedDeptCode }) {
  ...
  return <GeoJSON key={selectedDeptCode || "none"} data={data} style={style} onEachFeature={onEach} />;
}
